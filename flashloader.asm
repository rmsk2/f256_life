...
.text "f256_life"                          ; name of the program used for starting
.byte $00                                  ; zero termination for "snake"
.byte $00                                  ; zero termination for parameter description
.text "Conway's game of life"              ; Comment shown in lsf
...
BLOCK1 .dstruct BlockSpec_t, $8A - 64, 0, 3, 32  ; copy flash block $4A (block number $8A) to RAM block 0. Start at offset $0300
BLOCK2 .dstruct BlockSpec_t, $8B - 64, 1, 0, 32  ; copy flash block $4B (block number $8B) to RAM block 1. Start at offset $0000
